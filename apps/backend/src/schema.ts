...
import {
  ...
  LinhaImportacao,
  ProvedorLlm,
  CredencialProvedorLlm,
  PerfilMapeamento,
  RegraMapeamento
} from "./domain/entities.js";
import { Usuario, SessaoUsuario } from "./domain/autenticacao-entities.js";
import { Plano } from "./domain/plano-entities.js";
import { VersaoRegrasPlano, ValorRegraPlano } from "./domain/regras-plano-entities.js";
...
const nomesTabelas: Record<string, string> = {
  usuarios: "usuarios", user_sessions: "sessoes_usuario", plans: "planos",
  plan_rules_versions: "versoes_regras_plano", plan_rule_values: "valores_regras_plano",
  avaliacoes: "avaliacoes", mapping_profiles: "perfis_mapeamento", mapping_rules: "regras_mapeamento",
...
const nomesColunas: Record<string, string> = {
  ...
  calculationRunId: "execucao_calculo_id", candidateCount: "quantidade_candidatos", candidateRank: "posicao_candidato", resultadoCandidatoId: "resultado_candidato_id",
